...
/**
  ...
  */
object DeDupOnEmailPhone extends DeDupResolutionTrait {


  override def groupingCriteriaId: Int = 7
  ...
  override def groupingIdentificationRule: Column = expr("(first_name is null or empty(first_name) or first_name='UNKNOWN') " +
    ...
    "and (address2_scrubbed is null or empty(address2_scrubbed) or address2_scrubbed='UNKNOWN') " +
  ...
  override def groupingColumns: Seq[String] = Seq("dedup_email_address", "dedup_phone_number")
}
